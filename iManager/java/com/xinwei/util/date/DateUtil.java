...
public class DateUtil {
	...
	public static Long getLong(String date){
		DateStyle dateStyle = getDateStyle(date);
		try {
			return getDateFormat(dateStyle.getValue()).parse(date).getTime();
	...
	/**
	 * 获取日期 。自定义日期格式。失败返回null。
	 * @param date 日期字符串
	 * @return 日期
	 */
	public static String getDate(String date,DateStyle dateStyle) {
		return StringToString(date, dateStyle);
	}
